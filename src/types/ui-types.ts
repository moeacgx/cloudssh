import type { HostNetworkInfo } from "./index.js";
...
export type Tab = {
  ...
  /** 当前 SSH 窗口是否固定，独立于主机收藏状态。 */
  sessionPinned?: boolean;
  /** true 表示由 tmux 托管，false 表示仅由 CloudSSH 平台保活。 */
  sessionManagedTmux?: boolean;
  /** 当前或可恢复的后端持久会话 ID。 */
  persistentSessionId?: string | null;
  /** 固定窗口对应的远端 tmux 会话名称。 */
  persistentTmuxSessionName?: string | null;
