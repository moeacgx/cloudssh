  ...
  async (req: Request, res: Response) => {
    ...
    try {
      ...
      await logAudit({
        ...
        username: await getActorUsername(createAuditActor.actorUserId),
  ...
  async (req: Request, res: Response) => {
    ...
    try {
      ...
      await logAudit({
        ...
        username: await getActorUsername(updateAuditActor.actorUserId),
  ...
  async (req: Request, res: Response) => {
    ...
    try {
      ...
      await logAudit({
        ...
        username: await getActorUsername(deleteAuditActor.actorUserId),
