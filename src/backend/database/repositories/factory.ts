...
import { UserDataLifecycleRepository } from "./user-data-lifecycle-repository.js";
...
import { WebTerminalSessionRepository } from "./web-terminal-session-repository.js";
...
export function createCurrentWebTerminalSessionRepository(): WebTerminalSessionRepository {
  return new WebTerminalSessionRepository(
    createCurrentRepositoryContext(),
    createCurrentRepositoryWriteHook("web_terminal_session_repository_write"),
  );
}
...
export function createCurrentUserDataLifecycleRepository(): UserDataLifecycleRepository {
  return new UserDataLifecycleRepository(
    createCurrentRepositoryContext(),
    createCurrentRepositoryWriteHook("user_data_lifecycle_repository_write"),
  );
}
