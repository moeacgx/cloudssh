...
// 每次测试动态生成，避免仓库中保存任何形似长期私钥的固定材料。
const generatedEd25519 = ssh2Pkg.utils.generateKeyPairSync("ed25519", {
  comment: "test@cloudssh.invalid",
});
const ED25519_PRIVATE = generatedEd25519.private;
const ED25519_PUBLIC = generatedEd25519.public;
